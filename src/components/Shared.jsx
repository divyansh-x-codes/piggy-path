...
export const BottomNav = ({ active }) => {
  ...
  return (
    <div style={{ position: 'fixed', bottom: 0, left: 0, right: 0, height: 78, paddingBottom: 'env(safe-area-inset-bottom)', background: 'white', borderTop: '2px solid black', display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 8px', zIndex: 1000 }}>
      ...
      <div onClick={() => navigate('/stocks')} style={{ flex: 1, height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', gap: 6 }}>
      ...
      <div onClick={() => navigate('/ipo')} style={{ flex: 1, height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', gap: 6 }}>
      ...
      <div style={{ flex: 1, display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
        <div onClick={() => navigate('/home')} style={{ width: 50, height: 50, borderRadius: '50%', background: '#4ade80', border: '2px solid black', display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', boxShadow: '3px 3px 0px #6D28D9', transform: 'translateY(-10px)' }}>
      ...
      <div onClick={() => navigate('/news')} style={{ flex: 1, height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', gap: 6 }}>
      ...
      <div onClick={() => navigate('/profile')} style={{ flex: 1, height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', gap: 6 }}>
